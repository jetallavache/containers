...
TEST_F(TestSet, Find_return_iter_int) {
  ...
  my_stl::Set<int>::iterator it = s.find(-26);
  EXPECT_EQ(*it, -26);
  it = s.find(0);
  EXPECT_EQ(*it, 0);
  it = s.find(55);
...
TEST_F(TestSet, Find_return_iter_double) {
  ...
  my_stl::Set<double>::iterator it = s.find(6.92929);
...
TEST_F(TestSet, Find_return_iter_string) {
  ...
  my_stl::Set<std::string>::iterator it = s.find("::");
  EXPECT_EQ(*it, "::");
  it = s.find("return");
  EXPECT_EQ(*it, "return");
...
TEST_F(TestSet, Find_return_const_iter_int) {
  ...
  my_stl::Set<int>::const_iterator it = s.find(-26);
  EXPECT_EQ(*it, -26);
  it = s.find(0);
  EXPECT_EQ(*it, 0);
  it = s.find(55);
...
TEST_F(TestSet, Find_return_const_iter_double) {
  ...
  my_stl::Set<double>::const_iterator it = s.find(6.92929);
  EXPECT_EQ(*it, 6.92929);
  it = s.find(0);
  EXPECT_EQ(*it, 0);
  it = s.find(55.111111);
...
TEST_F(TestSet, Find_returnconst__iter_string) {
  ...
  my_stl::Set<std::string>::const_iterator it = s.find("::");
  EXPECT_EQ(*it, "::");
  it = s.find("return");
  EXPECT_EQ(*it, "return");
  it = s.find("alloc_sential_and_proxy");
