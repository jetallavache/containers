...
TEST_F(TestTree, Find_return_iter_int) {
  ...
  my_stl::Tree<int, false>::iterator it = t.find(-26);
  EXPECT_EQ(*it, -26);
  it = t.find(0);
  EXPECT_EQ(*it, 0);
  it = t.find(55);
...
TEST_F(TestTree, Find_return_iter_double) {
  ...
  my_stl::Tree<double, false>::iterator it = t.find(6.92929);
...
TEST_F(TestTree, Find_return_iter_string) {
  ...
  my_stl::Tree<std::string, false>::iterator it = t.find("::");
  EXPECT_EQ(*it, "::");
  it = t.find("return");
  EXPECT_EQ(*it, "return");
...
TEST_F(TestTree, Find_return_const_iter_int) {
  ...
  my_stl::Tree<int, false>::const_iterator it = t.find(-26);
  EXPECT_EQ(*it, -26);
  it = t.find(0);
  EXPECT_EQ(*it, 0);
  it = t.find(55);
...
TEST_F(TestTree, Find_return_const_iter_double) {
  ...
  my_stl::Tree<double, false>::const_iterator it = t.find(6.92929);
  EXPECT_EQ(*it, 6.92929);
  it = t.find(0);
  EXPECT_EQ(*it, 0);
  it = t.find(55.111111);
...
TEST_F(TestTree, Find_return_const__iter_string) {
  ...
  my_stl::Tree<std::string, false>::const_iterator it = t.find("::");
  EXPECT_EQ(*it, "::");
  it = t.find("return");
  EXPECT_EQ(*it, "return");
  it = t.find("alloc_sential_and_proxy");
...
TEST_F(TestTree, Contains_string) {
  my_stl::Tree<std::string, false> s;
