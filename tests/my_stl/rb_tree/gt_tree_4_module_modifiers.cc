...
TEST_F(TestTree, Insert_initializer_list_string) {
  my_stl::Tree<std::string, false> t3;
  t3.insert({"my_stl", "::", "::", "::", "alloc_sential_and_proxy", "()",
...
TEST_F(TestTree, Insert_many_int) {
  my_stl::Tree<int, false> t;
  std::vector<std::pair<my_stl::Tree<int, false>::iterator, bool>> v =
...
TEST_F(TestTree, Insert_many_double) {
  my_stl::Tree<double, false> t;
  std::vector<std::pair<my_stl::Tree<double, false>::iterator, bool>> v =
...
TEST_F(TestTree, Insert_many_string) {
  my_stl::Tree<std::string, false> t;
  std::vector<std::pair<my_stl::Tree<std::string, false>::iterator, bool>> v =
...
TEST_F(TestTree, Erase_string) {
  my_stl::Tree<std::string, false> t;
  t.insert({"my_stl", "::", "alloc_sential_and_proxy", "()", "{-26.9876}",
            "return"});
