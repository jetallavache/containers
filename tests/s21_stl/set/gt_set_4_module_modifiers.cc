...
TEST_F(TestSet, Insert_initializer_list_string) {
  ...
  s1.insert({"s21", "::", "::", "::", "alloc_sential_and_proxy", "()",
             "{-26.9876}", "return", "s21", "::", "alloc_sential_and_proxy"});
  std::set<std::string> s2({"s21", "::", "::", "::", "alloc_sential_and_proxy",
                            "()", "{-26.9876}", "return", "s21",
...
TEST_F(TestSet, Swap_int) {
  s21::Set<int> expect_left({3, 5, 7, 9, 11, 23, 4, 0, 12, 23, -98});
  s21::Set<int> expect_right({-5, -3, -1, 1});

  s21::Set<int> s_left({-5, -3, -1, 1});
  s21::Set<int> s_right({3, 5, 7, 9, 11, 23, 4, 0, 12, 23, -98});
...
TEST_F(TestSet, Swap_double) {
  s21::Set<double> expect_left(
      {-5.1, -3.2, -1.3, 1.4, 3.5, 5.6, 7.7, 9.8, 11.9, 23.1});
  s21::Set<double> expect_right({-1.312, 1.412, 3.512});

  s21::Set<double> s_left({-1.312, 1.412, 3.512});
  s21::Set<double> s_right(
      {-5.1, -3.2, -1.3, 1.4, 3.5, 5.6, 7.7, 9.8, 11.9, 23.1});
...
TEST_F(TestSet, Swap_string) {
  s21::Set<std::string> expect_left({"dssw", "woiweu3", "qaz34", "09--wk",
                                     "12+kls", "ncls()", "@#$F", "ddkjhd"});
  s21::Set<std::string> expect_right({"woiweu3", "qaz34", "09--wk"});

  s21::Set<std::string> s_left({"woiweu3", "qaz34", "09--wk"});
  s21::Set<std::string> s_right({"dssw", "woiweu3", "qaz34", "09--wk", "12+kls",
                                 "ncls()", "@#$F", "ddkjhd"});
...
TEST_F(TestSet, Merge_int) {
  s21::Set<int> s_union({-5, -3, -1, 1, 3, 5, 7, 9, 11, 23});
  s21::Set<int> s_left({-5, -3, -1, 1});
  s21::Set<int> s_right({3, 5, 7, 9, 11, 23});
...
TEST_F(TestSet, Merge_double) {
  s21::Set<double> s_union(
      {-5.1, -3.2, -1.3, 1.4, 3.5, 5.6, 7.7, 9.8, 11.9, 23.1});
  s21::Set<double> s_left({-5.1, -3.2, -1.3, 1.4});
  s21::Set<double> s_right({3.5, 5.6, 7.7, 9.8, 11.9, 23.1});
...
TEST_F(TestSet, Merge_string) {
  s21::Set<std::string> s_union({"dssw", "woiweu3", "qaz34", "09--wk", "12+kls",
                                 "ncls()", "@#$F", "ddkjhd"});
  s21::Set<std::string> s_left({"dssw", "woiweu3"});
  s21::Set<std::string> s_right(
