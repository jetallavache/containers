...
TEST_F(TestTree, Iterator_begin) {
  ...
  s21::Tree<int, false>::iterator it;
  it = t.begin();
  EXPECT_EQ(*it, -25);
}
...
TEST_F(TestTree, Const_iterator_begin) {
  ...
  s21::Tree<int, false>::const_iterator cit;
  cit = t.begin();
  EXPECT_EQ(*cit, -25);
}
...
TEST_F(TestTree, Const_iterator_end) {
  ...
  s21::Tree<int, false>::const_iterator it;
  it = t.end();
  EXPECT_EQ(*it, 0);
}
...
TEST_F(TestTree, Iterator_postfix_increment) {
  ...
  s21::Tree<int, false>::iterator it = t.begin();
  s21::Tree<int, false>::iterator it2 = t.begin();
  for (; it2 != t.end();) {
    it++;
    it2++;
    EXPECT_EQ(*it, *it2);
...
TEST_F(TestTree, Const_iterator_postfix_increment) {
  ...
  s21::Tree<int, false>::const_iterator it = t.begin();
  s21::Tree<int, false>::const_iterator it2 = t.begin();
  for (; it2 != t.end();) {
    it++;
    it2++;
    EXPECT_EQ(*it, *it2);
...
TEST_F(TestTree, Iterator_postfix_decrement) {
  ...
  s21::Tree<int, false>::iterator it = t.end();
  s21::Tree<int, false>::iterator it2 = t.end();
  for (; it2 != t.end();) {
    it--;
    it2--;
    EXPECT_EQ(*it, *it2);
...
TEST_F(TestTree, Const_iterator_postfix_decrement) {
  ...
  s21::Tree<int, false>::const_iterator it = t.end();
  s21::Tree<int, false>::const_iterator it2 = t.end();
  for (; it2 != t.end();) {
    it--;
    it2--;
    EXPECT_EQ(*it, *it2);
...
TEST_F(TestTree, Iterator_get_ref) {
  s21::Tree<std::pair<int, char>, false> t;
  ...
  s21::Tree<std::pair<int, char>, false>::iterator it = t.begin();
